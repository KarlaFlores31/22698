...
@Composable
fun Otravez(reiniciar:(Boolean) -> Unit, pantalla1:(Boolean) ->Unit, pantalla2:(Boolean) ->Unit, estado: Boolean, modifier: Modifier){
...
fun OtravezPreview(){
    ...
    var activo by remember { mutableStateOf(value = false)}

    Otravez({reiniciar = it},{pantalla1 = it},{pantalla2 = it},activo, modifier = Modifier
